...
const fases = [
  { texto: "Inhala", duracion: 5000 },
  { texto: "Mantén", duracion: 5000 },
  { texto: "Exhala", duracion: 5000 },
];

export  function Ejercicio555() {
  ...
  const iniciarRespiracion = () => {
    ...
    const totalDuracion = fases.reduce((sum, f) => sum + f.duracion, 0);
  ...
  return (
    <LinearGradient colors={["#16222A", "#3A6073"]} style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.title}>Respiración 5-5-5</Text>
